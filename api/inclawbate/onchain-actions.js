...
// feePreference: [1, 1] = Paired (WETH only) for both recipients (default 2-recipient)
const LOCKER_DATA_2 = '';
// feePreference: [1] = Paired (WETH only) for single recipient
const LOCKER_DATA_1 = '';
...
export async function launchToken({ name, symbol, creator_wallet, description, image_url, website_url, x_handle, telegram_url, reward_recipients, reward_bps, airdrop_address, airdrop_pct }) {
  ...
  const deploymentConfig = {
    ...
    lockerConfig: {
      ...
      tickUpper: [-120000],
      positionBps: [10000],
      lockerData: rewardRecipients.length === 1 ? LOCKER_DATA_1 : LOCKER_DATA_2
    },
    mevModuleConfig: {
