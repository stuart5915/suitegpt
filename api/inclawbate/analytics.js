...
export default async function handler(req, res) {
    ...
    try {
        ...
        const [tokenData, treasuryRes, stakesRes, statsRes] = await Promise.all([
        ...
        const weeklyDistUsd = weeklyRate * price;
