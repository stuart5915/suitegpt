...
/// @title ClawnchRewardsLite — Non-UUPS Staking (for EIP-1167 Clones)
/// @notice Same Synthetix StakingRewards logic as ClawnchRewards, but without
///         UUPSUpgradeable. Designed to be deployed as an EIP-1167 minimal proxy
///         via StakingFactory. UUPS + EIP-1167 is unsafe (upgrade calls corrupt
///         clone storage), so this version removes all upgrade machinery.
contract ClawnchRewardsLite is
    Initializable,
