    ...
    var TEMPLATES = {
        ...
        1: [ // Monday — Building in Public
            ...
            { type: 'Reel', caption: 'When people ask what I\'m building:\n\nA platform where AI agents and humans earn together.\nYes, really.\n\n{humans} humans and counting.', tags: ['#BuildInPublic', '#Inclawbate', '#AI', '#Founder', '#CryptoReels'],
              videoPrompt: 'Close-up of hands typing on a keyboard in a bright workspace, morning light streaming in. The screen shows an app coming together in real-time. Quick cuts: a person testing it on their phone, showing a friend, the friend signing up. Pull back to reveal a wall of small screens showing different people around the world using apps built on the platform. Warm, fast-paced, hopeful energy. 10 seconds.' }
        ],
        2: [ // Tuesday — Education
        ...
        3: [ // Wednesday — Token / Data Update
            ...
            { type: 'Reel', caption: 'INCLAWNCH by the numbers:\n\n${price} per token\n{change}% in 24h\n{stakers} stakers\n{apy}% APY\n\nThe engine is real.', tags: ['#INCLAWNCH', '#Crypto', '#Base', '#DeFi', '#CryptoReels'],
              videoPrompt: 'Quick montage of real people checking their phones — staking numbers going up, apps being built, a team coordinating resources. Each scene warm and bright, natural light. Numbers appear as clean typography overlays between scenes. Final shot: a person putting their phone down and smiling, knowing the engine works. Warm golden tones, editorial feel. 10 seconds.' }
        ],
        4: [ // Thursday — Meme / Relatable
            { type: 'Single Image', caption: 'Me explaining to my friends that an AI platform is paying people to build:\n\n"So there\'s this thing called Inclawbate..."\n\n{humans} humans get it. Do you?', tags: ['#Inclawbate', '#CryptoMeme', '#Meme', '#Web3Humor', '#AI'] },
            { type: 'Reel', caption: 'Normal people: "What do you do for work?"\n\nMe: "I build apps with AI and earn tokens at ${price} each"\n\nNormal people: ...', tags: ['#Inclawbate', '#CryptoHumor', '#Meme', '#Web3Life', '#AI'],
              videoPrompt: 'Split screen: left side a person at a regular office job looking bored, right side a person at a bright home desk building an app with a smile, phone buzzing with reward notifications. The office worker glances over jealously. Warm, comedic, relatable energy. 10 seconds.' },
